...
public class WomanHelpline extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_woman_helpline);
    ...
    public void onLocationChanged(Location location) {
        ...
        */
        ...
        Intent i = new Intent(WomanHelpline.this,WomanHelplineConfirmation.class);
        i.putExtras(b);
        startActivity(i);
        WomanHelpline.this.finish();
