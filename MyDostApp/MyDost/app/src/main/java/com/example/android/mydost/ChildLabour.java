...
public class ChildLabour extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_child_labour);
    ...
    public void onLocationChanged(Location location) {
        ...
        */
        ...
        Intent i = new Intent(ChildLabour.this,ChildLabourConfirmation.class);
        i.putExtras(b);
        startActivity(i);
        ChildLabour.this.finish();
